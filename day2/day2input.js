const input = ['15-19 k kkkkkkkkkkkkzkkkkkkk',
...
const parsedPuzzleInput = input.map(string => {
    const splits = string.split(" ")
    const range = splits[0].split("-")
    const numericalRange = range.map(stringNum => Number(stringNum))
    splits[0] = numericalRange
    return splits
});
